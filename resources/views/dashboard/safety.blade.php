...
<body class="min-h-screen bg-gray-100">
    ...
    <main class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <p class="mb-6 text-sm text-gray-600">{{ __('Oversees drivers, licenses, and safety compliance.') }}</p>
        <div class="rounded-lg border border-gray-200 bg-white px-6 py-8 shadow-sm space-y-4">
            ...
            <p class="text-gray-700"><span class="font-medium">{{ __('Total Drivers') }}:</span> —</p>
            <p class="text-gray-700"><span class="font-medium">{{ __('Licenses Expiring Soon') }}:</span> —</p>
